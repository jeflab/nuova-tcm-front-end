        ...
        <dl className="mb-0">
          {["legacy", "transfer-sdd"].includes(paymentData.paymentType) && (
            <>
              ...
              <dd>
                ...
                italiano aperto presso Banca Intesa-Sanpaolo - Via Cesare
                Battisti n. 11 - Milano 20122 Filiale: 1886 IBAN
          ...
          {["credit-card", "mollie"].includes(paymentData.paymentType) && (
            <>
              ...
              <ul>
                <li>
                  Nella causale di pagamento deve sempre essere indicato il
                ...
                <li>
                  ...
                  frazionamento diverso) sulla medesima Carta di Credito o
                  Debito di cui è titolare esclusivo. I premi successivi
                  verranno addebitati automaticamente alle scadenze previste dal
                  frazionamento prescelto dal Contraente.
                </li>
              </ul>
              <dt>Tipo di pagamento: ricorrente</dt>
              <dd className="mb-0">
                Con la sottoscrizione della presente autorizzazione, il
                Contraente si obbliga a pagare tutti i premi successivi al primo
                tramite addebito diretto sulla propria Carta di Credito o
                Debito. Specificatamente, il Contraente si obbliga ed impegna a
                fornire prontamente i dati dell’eventuale Carta di Credito o
                Debito sostitutiva (in caso di furto/smarrimento o sostituzione
                per scadenza).
              </dd>
            </>
          )}
